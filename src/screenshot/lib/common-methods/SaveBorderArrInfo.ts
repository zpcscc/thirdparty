import type { cutOutBoxBorder, positionInfoType } from 'src/screenshot/lib/type/ComponentType';
 ...
 * @private
 */
const saveBorderArrInfo = (borderSize: number, positionInfo: positionInfoType) => {
  // 获取裁剪框位置信息
...
export default saveBorderArrInfo;
